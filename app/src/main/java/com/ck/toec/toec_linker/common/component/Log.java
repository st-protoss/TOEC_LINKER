...
import com.ck.toec.toec_linker.common.utils.TimeUtil;
...
public class Log {
    ...
    private static final String PATH = BaseApp.getAppCacheDir();
    ...
    public static void e(String TAG, String msg) {
        android.util.Log.e(TAG, log(msg));
    ...
    public static void w(String TAG, String msg) {
        if (isDebug) {
            android.util.Log.w(TAG, log(msg));
            if (PLOG_WRITE_TO_FILE) {
    ...
    public static void i(String TAG, String msg) {
        if (isDebug) {
            android.util.Log.i(TAG, log(msg));
            if (PLOG_WRITE_TO_FILE) {
